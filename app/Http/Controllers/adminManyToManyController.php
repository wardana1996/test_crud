...
use App\Http\Requests\adminManyToManyRequest;
...
class adminManyToManyController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin_many_to_many');
    }
    ...
    public function create(adminManyToManyRequest $request)
    { 
    ...
    public function update(adminManyToManyRequest $request, $id)
    { 
