...
use App\Http\Requests\adminToManyRequest;
...
class adminToManyController extends Controller
{
    ...
    public function create(adminToManyRequest $request)
    { 
        $phone = new PhoneMany();
    ...
    public function update(adminToManyRequest $request, $id)
    { 
