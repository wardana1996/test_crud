...
use App\Http\Requests\employeeHasOneRequest;
...
class employeeController extends Controller
{
    ...
    public function create(employeeHasOneRequest $request)
    { 
        $member = new Member();
    ...
    public function update(employeeHasOneRequest $request, $id)
    { 
        DB::beginTransaction();
